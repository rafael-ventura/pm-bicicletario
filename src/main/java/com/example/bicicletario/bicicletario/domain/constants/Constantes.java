...
public class Constantes {
    ...
    public static final String ID_TRANCA_INVALIDA = "Id da tranca inválido";
    public static final String ERROR_ENVIAR_EMAIL = "Erro ao enviar email";
    public static final String FUNCIONARIO_IGUAL = "Funcionário não é o mesmo que solicitou a ação";
    public static final String FUNCIONARIO_INVALIDO = "Funcionário inválido";
    ...
    public static final String TRANCA_ENCONTRADA = "Tranca encontrada";
    public static String NAO_ENCONTRADO = "Não encontrado";
    public static String DADOS_INVALIDOS_TRANCAR = "Dados Inválidos ou tranca já se encontra trancada";
}
