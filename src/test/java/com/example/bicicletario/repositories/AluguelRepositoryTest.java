...
class AluguelRepositoryTest {
    ...
    @Test
    void testFindByBicicletaAndHoraFimIsNull_Success() {
        // Arrange
        Aluguel aluguel = new Aluguel();
        ...
        // Act
        Optional<Aluguel> retrievedAluguel = aluguelRepository.findByBicicletaAndHoraFimIsNull(1);
    ...
    @Test
    void testFindByBicicletaAndHoraFimIsNull_NotFound() {
        // Act
        Optional<Aluguel> retrievedAluguel = aluguelRepository.findByBicicletaAndHoraFimIsNull(1);
